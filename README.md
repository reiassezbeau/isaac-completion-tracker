...
[![Download](https://img.shields.io/badge/Download-.exe%20Windows-c1272d?style=for-the-badge&logo=windows)](https://github.com/reiassezbeau/isaac-completion-tracker/releases/download/v0.6.1/Isaac-Completion-Tracker_0.6.1_x64-setup.exe)
...
**[⬇️ Download the Windows installer (.exe)](https://github.com/reiassezbeau/isaac-completion-tracker/releases/download/v0.6.1/Isaac-Completion-Tracker_0.6.1_x64-setup.exe)** — run it, done.
